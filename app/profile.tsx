...
const Profile: React.FC = () => {
  ...
  // Used for resizing screen in real time
  ...
  return (
    <SafeAreaView className="flex-1 justify-center items-center bg-primary_red">
      ...
      >
        <Text className="font-pangolin text-[70px] p-5 text-center">
          Create Profile
        </Text>
        ...
        <View className="flex-row items-center">
          ...
          >
            <View className="flex-1 justify-center items-center bg-primary_red">
              ...
              <Text className="text-[30px] m-5 font-pangolin">
                Intermediate: Shorter time to guess with access to a single
                hint.
              </Text>
              <Text className="text-[30px] m-5 font-pangolin">
        ...
        {/* Icon selection */}
        <View className="w-[40%] min-w-[400px]">
